...
def generate_builder1_headline_o3(
    *,
    ...
    system = (
        ...
        "- advertisingPromise is the advertising promise; it helped discover Object B.\n"
        "- Now formulate that advertisingPromise in words as the headline (not as literal explanation text).\n"
        "- Generate headlineText from final visual meaning using objectA, objectASecondary, objectB, modeDecision, visualDescription, visualPrompt, and advertisingPromise.\n"
        ...
        "- The phrase must be a result of advertisingPromise, not a literal product explanation.\n"
