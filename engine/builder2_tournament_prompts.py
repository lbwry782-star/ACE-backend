...
def build_creator_prompt(
    *,
    ...
    return (
        ...
        f"Follow this order: {stage_order}.\n"
        ...
        "visualParallelType, visualFamily, structureType, creativeOrderConfirmation, prototypeMethodApplication, "
...
def build_winner_development_prompt(
    *,
    ...
    return (
        ...
        "Generate the headline ONLY now when headlineDecision.decision=include. Headline remainder max seven words excluding product name.\n"
        "When headlineDecision.decision=omit, leave headline fields empty and set headlineForm=none.\n"
        f"Video duration seconds: {duration}\n"
