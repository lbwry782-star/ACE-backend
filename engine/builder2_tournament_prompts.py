...
def build_winner_development_prompt(
    *,
    ...
    return (
        ...
        "omit suppresses text inside the Runway scene only; Advertising Closure is still mandatory after Runway.\n"
        "Required advertisingClosure object: required=true, productNameText, sloganText, language, "
        "presentationMode=end_card, durationSeconds=1.5, headlineSource, noLogo=true.\n"
        f"Video duration seconds: {duration}\n"
