...
class TestSeriesAndRegression(unittest.TestCase):
    ...
    def test_stage_order_unchanged_in_pipeline(self) -> None:
        ...
        self.assertLess(source.index("build_brand_physical_user_prompt"), source.index('"graphic_system"'))
        self.assertLess(source.index('"graphic_system"'), source.index("_run_series_stage_with_integrity"))
